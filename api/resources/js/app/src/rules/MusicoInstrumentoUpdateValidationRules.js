...
const musicoinstrumentoUpdateValidationRules = {
...
export const useValidarDadosMusicoInstrumentoUpdate = () => {
    return useValidator(MUSICOINSTRUMENTO, ERROR_MUSICOINSTRUMENTO, musicoinstrumentoUpdateValidationRules);
}