...
const instrumentoUpdateValidationRules = {
...
export const useValidarDadosInstrumentoUpdate = () => {
    return useValidator(INSTRUMENTO, ERROR_INSTRUMENTO, instrumentoUpdateValidationRules);
}